---
inclusion: fileMatch
fileMatchPattern: 'mypresensi-web/**'
...
- ❌ `import ... from '@/src/lib/...'` — folder `src/` SUDAH DIHAPUS (BUG-002 closed). JANGAN bikin folder `src/` baru di sub-folder mypresensi-web.

Catatan historis: Next.js scaffold awalnya generate `src/`, dihapus saat BUG-002 fix. Semua kode app sekarang langsung di `mypresensi-web/app/...`.
