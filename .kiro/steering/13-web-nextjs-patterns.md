...
4. **Path alias `@/*` → `./app/*`** (BUKAN `./src/*`). Folder `mypresensi-web/src/` sudah dihapus (BUG-002 closed total) — JANGAN bikin folder `src/` baru, semua kode app langsung di `mypresensi-web/app/...`.
